...
void main() {
  test('Calcula o valor do produto com desconto do sem porcentagem', () {
  ...
  test(
      'Calcula o valor do produto com desconto sem porcentagem passando valor do produto serado',
      () {
  ...
  group("Calcula o valor do produto com valores zerados, deve retornar erro",
      () {
    var valuesToTest = {
  ...
  test('Testar conversão para Uppercase', () {
    expect(app.convertToUpper('lavynia'), equals('LAVYNIA'));
  });

  test('Testar conversão para Uppercase 2 ', () {
    expect(app.convertToUpper('lavynia'), equalsIgnoringCase('lavynia'));
  });

  test('Começa com', () {
    expect(app.convertToUpper('lavynia'), startsWith('L'));
  });
